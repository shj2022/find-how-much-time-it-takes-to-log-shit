//  copy & paste the below from ML training code
...
basic.forever(function on_forever() {
    ...
    rawZ.push(input.acceleration(Dimension.Z))
    basic.pause(97)
    current_activity.push(activities[predict(feature_package(rawX, rawY, rawZ))])
    basic.showString(current_activity[current_activity.length - 1], 1)
    rawX.removeAt(0)
    rawY.removeAt(0)
    rawZ.removeAt(0)
})
